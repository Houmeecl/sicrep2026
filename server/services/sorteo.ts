/**
 * Sorteo del impulso a viaje de negocios a China: 50 cupos entre las empresas inscritas
...
export const CUPOS_VIAJE_CHINA = 50;

export function sortearGanadores<T>(elegibles: T[], cupos: number = CUPOS_VIAJE_CHINA): T[] {
